...
object ProfanityFilter {
    ...
    private val profanityEntries = listOf(
        ...
        ProfanityEntry("tite",        Severity.STRONG),
        ProfanityEntry("etits",       Severity.STRONG),
        ProfanityEntry("burat",       Severity.STRONG),
        ProfanityEntry("puke",        Severity.STRONG),
        ProfanityEntry("bilat",       Severity.STRONG),
        ProfanityEntry("pepe",        Severity.STRONG),
        ProfanityEntry("titi",        Severity.STRONG),
        ProfanityEntry("supot",       Severity.STRONG),
        ProfanityEntry("pakyu",       Severity.STRONG),
        ProfanityEntry("pakingshet",  Severity.STRONG),
        ProfanityEntry("kingina",     Severity.STRONG),
        ProfanityEntry("kinginamo",   Severity.STRONG),
        ProfanityEntry("yawa",        Severity.STRONG),
        ProfanityEntry("ungas",       Severity.STRONG),
        ProfanityEntry("engot",       Severity.STRONG),
        ProfanityEntry("lintik",      Severity.STRONG),
        ProfanityEntry("hudas",       Severity.MILD),
        ProfanityEntry("animal ka",   Severity.STRONG),
        ProfanityEntry("hayop ka",    Severity.STRONG),
        ProfanityEntry("gago ka",     Severity.STRONG),
        ProfanityEntry("tangina mo",  Severity.STRONG),
