...
class FallDetectionService : Service(), SensorEventListener {
    ...
    companion object {
        ...
        // Persisted separately from Compose state so a restart (after the OS
        // kills the process) can tell whether monitoring was actually meant
        // to be on, instead of guessing.
    ...
    override fun onStartCommand(intent: Intent?, flags: Int, startId: Int): Int {
        ...
        // A null action means Android restarted this service after the process
        // was killed (e.g. low memory), not an explicit request from the app.
        // Check the last confirmed toggle state rather than guessing — resume
        // monitoring only if the user actually had it on.
